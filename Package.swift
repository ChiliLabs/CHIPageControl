...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "Jalapeno", path: "CHIPageControl", exclude: ["CHIPageControlAji.swift","CHIPageControlAleppo.swift",["CHIPageControlChimayo.swift", "CHIPageControlFresno.swift", "CHIPageControlJaloro.swift", "CHIPageControlPaprika.swift", "CHIPageControlPuya.swift"]),
